  ...
  return knex('recipe').del()
    .then(function () {
      ...
      return knex('recipe').insert([
        ...
        {id: 6, name: 'Assemble', ingredients: 'The burger', time: '5', steps_id: 1, img_url: 'https://www.napoleongrills.com/Portals/0/images/Blog/1_590lb-burger-weight-300x300.jpg'}
      ]);
    });
};
